  ...
  if (! initialized)
    {
      ...
      tmppath = concat (ld_sysroot, "/home/ubuntu/share/openwrt-mtk/staging_dir/toolchain-mipsel_24kec+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/etc/ld.so.conf",
			(const char *) NULL);
...
OUTPUT_ARCH(mips)\n\
ENTRY(__start)\n\
SEARCH_DIR(\"/home/ubuntu/share/openwrt-mtk/staging_dir/toolchain-mipsel_24kec+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/mipsel-openwrt-linux-uclibc/lib32\"); SEARCH_DIR(\"=/usr/local/lib32\"); SEARCH_DIR(\"=/lib32\"); SEARCH_DIR(\"=/usr/lib32\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
